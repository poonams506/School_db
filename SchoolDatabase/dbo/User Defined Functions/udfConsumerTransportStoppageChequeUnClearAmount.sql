CREATE FUNCTION udfConsumerTransportStoppageChequeUnClearAmount (@AcademicYearId SMALLINT, @ConsumerId BIGINT, @RoleId SMALLINT, @TransportConsumerStoppageMappingId INT)
RETURNS MONEY AS
BEGIN
