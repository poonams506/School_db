...
-- Description:  This stored procedure is used to get grade division mapping info details for cascading only
-- =============================================
CREATE PROC uspSchoolGradeDivisionMatrixCascadeSelect 
@AcademicYearId INT
AS Begin 
SET 
