...
-- Description:  This stored procedure is used to get Payment Datewise report
-- =============================================
CREATE PROCEDURE [dbo].[uspPaymentReportDaywise] (@StartDate DateTime,@EndDate DateTime)
AS Begin 
SET 
