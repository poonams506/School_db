...
-- =============================================
CREATE PROCEDURE [dbo].[uspFeePaymentHistoryGridSelect]
...
BEGIN TRY
 ...
 ORDER BY
 CASE WHEN @OrderBy=0 THEN row_number() over(order by FeePaymentId asc) END DESC,
...
ELSE
 ...
 ORDER BY
 CASE WHEN @OrderBy=0 THEN row_number() over(order by FeePaymentId asc) END ASC,
