...
-- Description:  This stored procedure is used to get Student Kit Payment Analytics for School
-- =============================================
CREATE PROC [dbo].[uspStudentKitPaymentAnalyticsSchool] (@AcademicYearId SMALLINT) AS Begin 
SET 
