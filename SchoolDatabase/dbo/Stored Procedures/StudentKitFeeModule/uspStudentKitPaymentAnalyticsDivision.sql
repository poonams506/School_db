...
-- =============================================
CREATE PROC [dbo].[uspStudentKitPaymentAnalyticsDivision] (@GradeId SMALLINT, @AcademicYearId SMALLINT) AS Begin 
SET 
...
SELECT DISTINCT g.GradeId,d.DivisionId, d.DivisionName,
...
WHERE m.GradeId = @GradeId AND m.AcademicYearId = @AcademicYearId AND s.IsDeleted<>1 AND M.IsDeleted <> 1
GROUP BY d.DivisionId,d.DivisionName,g.GradeId
