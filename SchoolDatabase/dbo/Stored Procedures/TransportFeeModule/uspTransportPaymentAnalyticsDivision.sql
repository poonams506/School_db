...
-- =============================================
CREATE PROC [dbo].[uspTransportPaymentAnalyticsDivision] (@AcademicYearId SMALLINT, @GradeId SMALLINT) AS Begin 
SET 
...
SELECT  
	d.DivisionId,g.GradeId, g.GradeName, d.DivisionName,
...
WHERE M.AcademicYearId = @AcademicYearId AND m.GradeId = @GradeId AND m.IsDeleted<> 1 AND s.IsDeleted <> 1 
GROUP BY d.DivisionId,g.GradeId, g.GradeName,d.DivisionName
