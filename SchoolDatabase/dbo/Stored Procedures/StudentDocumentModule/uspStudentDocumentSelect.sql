...
-- =============================================
CREATE PROC [uspStudentDocumentSelect]
(
...
FROM 
  StudentDocuments 
WHERE 
	 DocumentId = ISNULL(@DocumentId, DocumentId) AND IsDeleted <> 1 END TRY BEGIN CATCH DECLARE @ErrorMessage VARCHAR(5000) = ERROR_MESSAGE();
